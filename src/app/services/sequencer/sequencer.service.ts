import { Clock } from 'src/models/system/sequencer/Clock.model';
import { OutputService } from './../io/output.service';
...
import {
  PatternEvent,
  PatternEventActions,
} from 'src/models/entity/PatternEvent.model';
import { Position } from 'src/models/entity/Position.model';
import { TimeSignature } from 'src/models/entity/TimeSignature.model';
import { ControlModeEnum } from 'src/models/system/control/ControlMode.model';
...
export class SequencerService {
  ...
  play(): void {
    ...
    //this.outputService.getSequencer().play();
  }

  pause(): void {
    this.setPlaying(false);

    // this.outputService.getSequencer().pause();
  }
